...
<div class="container-fluid bg-dark text-light mb-5 mt-5">
    <div class="row row-cols-1 row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-xm-1 mt">
      <div class="col">
        <div class="container">
    ...
    <div class="container">
    <form action="{{ route('pcontact.store') }}" method="POST">
    @csrf
