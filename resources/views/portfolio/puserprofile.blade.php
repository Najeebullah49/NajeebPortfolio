...
<div class="container py-4">
  <div class="profile-card text-center">
    ...
    <div class="mb-2 position-relative">
      <form action="{{ route('pupdate.profile.picture') }}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <!-- Name Edit -->
    <form class="col-12" method="POST" action="{{ route('pupdateUserName') }}">
      @csrf
    ...
    <!-- Email -->
    <form class="col-12" method="POST" action="{{ route('pupdateUserEmail') }}">
      @csrf
      <div class="input-group mb-3">
        <span class="input-group-text">
    ...
    <!-- Password -->
<form action="{{ route('puser.updatePassword') }}" method="POST">
  @csrf
