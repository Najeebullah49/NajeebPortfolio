...
@endif
    ...
    <div class="row justify-content-between align-items-center">
        ...
        <div class="col text-end">
            ...
            <form action="{{ route('madmin.updatePicture') }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                @csrf
    ...
    <div class="col text-end mt-3 ">
            <form action="{{ route('madmin.updateName') }}" method="POST" style="">
                @csrf
                ...
                <button type="submit" class="btn-sm app-btn-secondary mt-3 me-3">Change</button>
                        ...
                        <div class="item">
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col text-end">
                                <form class="form-control mt-3" action="{{ route('madmin.updateEmail') }}" method="POST" style="display: inline;">
                @csrf
...
<div class="modal fade" id="changePasswordModal" tabindex="-1" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('madmin.changePassword') }}" method="POST">
                @csrf
