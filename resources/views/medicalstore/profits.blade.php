...
<div id="layoutSidenav_content">
    ...
    new Chart(ctxArea, {
        ...
        data: {
            ...
            datasets: [{
                 label: `Total Revenue of [ ${currentMonth} ] month`,
...
new Chart(ctxBar, {
    ...
    data: {
        ...
        datasets: [{
            ...
            label: `Sold Stock Qunatity of [ ${thisMonth} ] month`,
